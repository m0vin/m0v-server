...
var (
        ...
        gethourlies = "select pub_hash, timestamp, voltage_max, voltage_min, voltage_ave, voltage_exceptions, frequency_max, frequency_min, frequency_ave, frequency_exceptions, import_active_energy, export_active_energy, import_reactive_energy, export_reactive_energy, total_active_energy, total_reactive_energy from hourly where timestamp > $1 and timestamp <= $2"

        getdailies = "select pub_hash, timestamp, voltage_max, voltage_min, voltage_ave, voltage_exceptions, frequency_max, frequency_min, frequency_ave, frequency_exceptions, import_active_energy, export_active_energy, import_reactive_energy, export_reactive_energy, total_active_energy, total_reactive_energy from daily where timestamp > $1 and timestamp <= $2"

        gethourliesbyhash = "select pub_hash, timestamp, voltage_max, voltage_min, voltage_ave, voltage_exceptions, frequency_max, frequency_min, frequency_ave, frequency_exceptions, import_active_energy, export_active_energy, import_reactive_energy, export_reactive_energy, total_active_energy, total_reactive_energy from hourly where timestamp > $1 and timestamp <= $2 and pub_hash=$3 order by timestamp asc"

        getdailiesbyhash = "select pub_hash, timestamp, voltage_max, voltage_min, voltage_ave, voltage_exceptions, frequency_max, frequency_min, frequency_ave, frequency_exceptions, import_active_energy, export_active_energy, import_reactive_energy, export_reactive_energy, total_active_energy, total_reactive_energy from daily where timestamp > $1 and timestamp <= $2 and pub_hash=$3 order by timestamp asc"
        //update statements
